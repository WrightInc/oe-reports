// OE Utility Services — 2026/27 AI Initiatives page (reports.oeservices.ca/ai)
// Basic Auth gate for /ai/* only — the rest of the site (e.g. the sustainability
// report) stays public because this middleware lives under functions/ai/.
